            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="app_container_group">
                    ...
                    <div class="app_container_group_list">
                        ...
                        <a href="{{ route('fe.profile.info') }}" class="app_container_group_list_name">Thay đổi thông tin tài khoản:</a>
                    </div>
                    <div class="app_container_group_list">
                        <div class="app_container_group_list_icon"><span class="ti-lock"></span></div>
                        <a href="{{ route('fe.profile.password') }}" class="app_container_group_list_name">Thay đổi mật khẩu</a>
                    </div>
                    <div class="app_container_group_list">
                        <div class="app_container_group_list_icon"><i class="fas fa-sign-out-alt"></i></div>
                        <a href="{{ route('logout') }}" class="app_container_group_list_name">Đăng xuất</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="app_container_group">
                    ...
                    <div class="app_container_group_list">
                        ...
                        <a href="{{ route('fe.profile.wishlist') }}" class="app_container_group_list_name">Sản phẩm yêu thích</a>
                    </div>
                    <div class="app_container_group_list">
                        <div class="app_container_group_list_icon"><span class="ti-eye"></span></div>
                        <a href="{{ route('fe.profile.order') }}" class="app_container_group_list_name">Lịch sử order</a>
                    </div>
                </div>
            </div>
        </div>
